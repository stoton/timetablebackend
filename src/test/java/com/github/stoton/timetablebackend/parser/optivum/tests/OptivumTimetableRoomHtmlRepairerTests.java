...
public class OptivumTimetableRoomHtmlRepairerTests {
    ...
    @Before
    public void init() {
        OptivumTimetableStrategy optivumTimetableStrategy = new OptivumTimetableRoomStrategy();
        optivumHtmlRepairer = new OptivumHtmlRepairer(optivumTimetableStrategy);
    }

    @Test
    public void fixRoomHtmlWhenHtmlIsCorrectTest() {
    ...
    @Test
    public void fixRoomHtmlWhenOneTagIsIncorrectTest() {
